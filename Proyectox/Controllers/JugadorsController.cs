...
namespace Proyectox.Controllers
{
    public class JugadorsController : Controller
    {
        ...
        public JugadorsController(ProyectoxContext context)
        {
            _context = context;
        }
        ...
        {
            var proyectoxContext = _context.Jugador.Include(j => j.Equipo);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Edad,Goles,Asistencias,Posicion,IdEquipo")] Jugador jugador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Edad,Goles,Asistencias,Posicion,IdEquipo")] Jugador jugador)
        {
            if (id != jugador.Id)
            {
                return NotFound();
